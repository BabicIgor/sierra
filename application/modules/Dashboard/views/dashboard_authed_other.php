...
<?php $up_id = uniqid();?>
  ...
  <div id="bigWrapper">
	...
	<!-- ############ PAGE START-->
	<div id="mainPanel" ng-controller="OtherController" style="padding:30px 0 50px;padding-left:70px;display:table;">
		...
		<div id="main_content" style="display:none;width:750px;float:left;">
			<div style="width:720px;height:auto;margin:10px auto;float:left;border-bottom:1px solid #eeeeee;margin-bottom:20px;padding-left:10px;margin-left:20px;padding-bottom:13px;">
