...
<?php $up_id = uniqid();?>
  ...
  <div id="bigWrapper">
	...
	<!-- ############ PAGE START-->
	<div id="mainPanel" ng-controller="ChatController" style="padding:30px 0 50px;padding-left:70px;display:table;">
		...
		<div id="main_content" style="display:none;width:750px;float:left;">
			...
			<div id="lowerMainPanel" ng-controller="HottestSessionsController" ng-show="page=='session'" style="width:750px;height:auto;margin:10px auto;float:left;">
				<div class="medium">
				<div class="sessionsTitle" style="font-size:14px;margin-top:0px;margin-bottom:0px;"> Popular Sessions</div>
			...
			<div id="lowerMainPanel" ng-controller="HottestSessionsController" ng-show="page=='profile'" style="width:750px;height:auto;margin:10px auto;float:left;">
				<div class="medium">
				
				</div>
			</div>
			<div id="lowerMainPanel" ng-show="page=='chat'" style="width:750px;height:auto;margin:10px auto;float:left;">
				<div class="medium">
					<div style="width:40%;float:left;margin-top:10px;">
						<div style="height:400px;border:none;margin-bottom:20px;overflow-y:auto;">
							<ul style="height:auto;margin-bottom:0px;margin-right:0px;max-height:400px;list-style:none;margin-top:0px;">
								<li>
									<a href="#" style="padding:10px 0;border-bottom:1px solid #f1f2f2;cursor:default;background:#fff;float:left;padding-top:0px;width:95%;">
										<div style="margin-left:10px;margin-right:10px;">
							            	<img src="<?php echo base_url();?>assets/img/unnamed.jpg" alt="user" style="float:left;width:40px;height:40px;border-radius:50%;" class="profile-photo">
											<div style="margin-left:50px;">
												<h6 style="color:#27aae1;margin-bottom:11px;">Linda Lohan</h6>
												<p class="text-muted" style="color:#939598;margin:0 0 10px;font-size:12px;">Hi there, how are you</p>
								...
								<li>
									<a href="#" style="padding:10px 0;border-bottom:1px solid #f1f2f2;cursor:default;background:#fff;float:left;padding-top:0px;width:95%;">
										<div style="margin-left:10px;margin-right:10px;">
											...
											<div style="margin-left:50px;">
												<h6 style="color:#27aae1;margin-bottom:11px;">Linda Lohan</h6>
												<p class="text-muted" style="color:#939598;margin:0 0 10px;font-size:12px;">see you soon</p>
								...
								<li>
									<a href="#" style="padding:10px 0;border-bottom:1px solid #f1f2f2;cursor:default;background:#fff;float:left;padding-top:0px;width:95%;">
										<div style="margin-left:10px;margin-right:10px;">
											...
											<div style="margin-left:50px;">
												<h6 style="color:#27aae1;margin-bottom:11px;">Linda Lohan</h6>
												<p class="text-muted" style="color:#939598;margin:0 0 10px;font-size:12px;">Okay fine, thank you</p>
								...
								<li>
									<a href="#" style="padding:10px 0;border-bottom:1px solid #f1f2f2;cursor:default;background:#fff;float:left;padding-top:0px;width:95%;">
										<div style="margin-left:10px;margin-right:10px;">
							            	<img src="<?php echo base_url();?>assets/img/unnamed.jpg" alt="user" style="float:left;width:40px;height:40px;border-radius:50%;" class="profile-photo">
											<div style="margin-left:50px;">
												<h6 style="color:#27aae1;">Linda Lohan</h6>
					...
					<div style="width:60%;float:left;">
						<div style="height:400px;border:none;margin-bottom:20px;overflow-y:auto;">
							<ul style="height:auto;margin-bottom:0px;margin-right:0px;max-height:400px;list-style:none;margin-top:0px;">
								<li style="list-style:none;margin-bottom:20px;">
					            	<img src="<?php echo base_url();?>assets/img/unnamed.jpg" alt="user" style="float:left;width:40px;height:40px;border-radius:50%;" class="profile-photo" />
					            	<div class="chat-item">
					            		<div style="border-bottom:1px dotted #caef8e;margin-bottom:10px;">
					            			<h5 style="font-size:12px;">Linda lohan</h5>
					            		</div>
					            		<p style="margin:0 0 10px;">Hi honey, how are you doing? Long time no see. Where have you been?</p>
					            	</div>
								</li>
								<li style="list-style:none;margin-bottom:20px;">
					            	<img src="<?php echo base_url();?>assets/img/unnamed.jpg" alt="user" style="float:left;width:40px;height:40px;border-radius:50%;float:right;" class="profile-photo" />
						...
						<div style="border-radius:4px;padding:2px;background:#f8f8f8;">
							<div style="position:relative;display:table;border-collapse:separate;width:81%;">
								<input type="text" class="form-control" placeholder="Type your message" style="float:left;height:auto;">
								<span style="position:absolute;float:left;font-size:0;white-space;nowrap;">
									<button class="btn" style="background:#000;color:#fff;position:relative;">Send</button>
								</span>
							</div>
						</div>
					</div>
