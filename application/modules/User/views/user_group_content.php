                                            ...
                                            <div class="row-col white bg">
                                                ...
                                                <div class="row-row">
                                                    <div class="row-body scrollable hover">
                                                        <div class="row-inner">
                                                            <!-- left content -->
                                                            <div class="list" data-ui-list="b-r b-3x b-primary" data-ui-list-target-class="show" id="group">
                                                                        ...
                                                                        <div class="list-body">
                                                                            <div class="pull-right dropdown">
                                                                                ...
                                                                                <div class="dropdown-menu pull-right text-color" role="menu">
                                                                                    <?php echo anchor('user/delete_video?gid='.$group->id, '<i class="fa fa-unlock-alt"></i>Delete Videos', 'class="dropdown-item"') ?>
                                                                            ...
                                                                            <div class="item-title"  id="<?php echo $group->id?>">
                                                                                <a href="#" class="_500" id="user_d"><?php echo $group->song_name; ?></a>
                                                                            </div>
                                                                            <small class="block text-muted text-ellipsis">
                                                                                <?php echo $group->artist_name?> - <?php echo $this->aauth->sec2time($group->duration);?>
                                                                            </small>
                                                                        </div>
                                                                    </div>
                                                                <?php }?>
